...
C     zen_fsol_daily     :: incoming solar radiation (daily mean)
     ...
     &                   exf_offset_atemp_xy,
     &                   exf_offset_aqh_xy,
     &                   exf_offset_swdown_xy,
     &                   exf_offset_lwdown_xy,
     &                   exf_offset_precip_xy
      _RL exf_offset_atemp_xy  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL exf_offset_aqh_xy    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL exf_offset_swdown_xy (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL exf_offset_lwdown_xy (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL exf_offset_precip_xy (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)

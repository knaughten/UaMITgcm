...
C     exf_offset_atemp_file  :: file with 2D temperature offset
C     exf_offset_aqh_file    :: file with 2D humidity offset
C     exf_offset_swdown_file :: file with 2D shortwave offset
C     exf_offset_lwdown_file :: file with 2D longwave offset
C     exf_offset_precip_file :: file with 2D precipitation offset
C     exf_offset_atemp_monthly  :: flag for monthly-varying temperature offset
C     exf_offset_aqh_monthly    :: flag for monthly-varying humidity offset
C     exf_offset_swdown_monthly :: flag for monthly-varying shortwave offset
C     exf_offset_lwdown_monthly :: flag for monthly-varying longwave offset
C     exf_offset_precip_monthly :: flag for monthly-varying precipitation offset
...
C-    File names.
      ...
      CHARACTER*(128) exf_offset_atemp_file
      CHARACTER*(128) exf_offset_aqh_file
      CHARACTER*(128) exf_offset_swdown_file
      CHARACTER*(128) exf_offset_lwdown_file
      CHARACTER*(128) exf_offset_precip_file

      LOGICAL exf_offset_atemp_monthly
      LOGICAL exf_offset_aqh_monthly
      LOGICAL exf_offset_swdown_monthly
      LOGICAL exf_offset_lwdown_monthly
      LOGICAL exf_offset_precip_monthly
     ...
     &       useKatabCorr, exf_offset_atemp_monthly,
     &       exf_offset_aqh_monthly, exf_offset_swdown_monthly,
     &       exf_offset_lwdown_monthly, exf_offset_precip_monthly
     ...
     &       exf_offset_atemp_file, exf_offset_aqh_file,
     &       exf_offset_swdown_file, exf_offset_lwdown_file,
     &       exf_offset_precip_file
...
c     _RL     exf_inscal_sss
      ...
      _RL     exf_inscal_swdown, exf_offset_swdown
      _RL     exf_inscal_lwdown, exf_offset_lwdown

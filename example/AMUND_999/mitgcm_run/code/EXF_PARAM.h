...
c     _RL     exf_inscal_sss
     ...
     &                      exf_inscal_swflux,
     &                      exf_inscal_lwflux,
     &                      exf_inscal_precip, exf_offset_precip,
...
c    &                      exf_inscal_sss,
     ...
     &                      exf_inscal_saltflx,
     &                      exf_inscal_swdown, exf_offset_swdown,
     &                      exf_inscal_lwdown, exf_offset_lwdown,
     &                      exf_inscal_tidePot,
     &                      exf_inscal_areamask,
     &                      exf_outscal_hflux,
     &                      exf_outscal_sflux,
...
C-   Monthly-climatology scaling factors:

      _RL exf_offset_monthly_atemp(12)

      COMMON /EXF_PARAM_MONTH_SCAL/
     & exf_offset_monthly_atemp			      

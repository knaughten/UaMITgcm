...
C     SEAICE_scaleDrag  :: scale SEAICE_drag parameter by spatially varying 
C                          values read from a file
      LOGICAL
...
C     SEAICE_scaleDragFile :: File containing scaling values for SEAICE_drag
C                             (only used if SEAICE_scaleDrag=.true.)
...
C
      ...
      CHARACTER*(MAX_LEN_FNAM) SEAICE_scaleDragFile
      COMMON /SEAICE_PARM_C/
     &   AreaFile, HsnowFile, HsaltFile, HeffFile,
     &   uIceFile, vIceFile, SEAICE_scaleDragFile

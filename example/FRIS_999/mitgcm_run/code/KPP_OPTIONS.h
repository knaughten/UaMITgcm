...
C o Force the surface boundary layer to go all the way to the bottom in user-specified regions (set useFrcConv and frcConvMaskFile in data.kpp)
#undef ALLOW_FORCED_CONVECTION

...
%% JDR 13/02/2024: remove this check because it does not work with the compiled
%% version of Ua-MITgcm. 
...
%% JDR 13/02/2024: remove this check because it does not work with the compiled
%% version of Ua-MITgcm. Instead, users should provide DefineGeometryAndDensities.m
%% with the correct input/output format, as specified above
% else
% 
